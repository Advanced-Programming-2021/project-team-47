...
public enum Regex {
    LOGIN(Pattern.compile("^user login (--password|--username) ([\\s\\S]+) (--password|--username) ([\\s\\S]+)$")),
    ...
    CREATE_USER(Pattern.compile("^user create (--password|--nickname|--username) ([\\s\\S]+) (--password|--nickname|--username) ([\\s\\S]+) (--password|--nickname|--username) ([\\s\\S]+)$")),
    ...
    CHANGE_PASSWORD(Pattern.compile("^profile change (--new|--password --current) ([\\s\\S]+) (--new|--password --current) ([\\s\\S]+)$")),
